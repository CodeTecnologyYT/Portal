...
var sctr=0;
var año20Dias=0;
var linkToken = $('#_csrf').attr('content');
var linkHeader = $('#_csrf_header').attr('content');
...
var urlConstanteDetall=window.location.origin+"/appincapacidad/api";
...
function tiene20Dias(solicitud) {
    ...
    $.ajax({
        ...
        beforeSend: function (xhr) {
            xhr.setRequestHeader(linkHeader, linkToken);
        },
        error: function () {
...
function enviarSolicitudAjax(solicitud){
    ...
    fetch(urlConstanteDetall + '/incapacidad/enviarSolicitud',{
        ...
        body: formData,
        headers: new Headers().append(linkHeader,linkToken)
